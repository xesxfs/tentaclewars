package com.adobe.images
{
   ...
   public class PNGEncoder
   {
      ...
      public static function encode(img:BitmapData) : ByteArray
      {
         ...
         IDAT.compress();
         method_70(png,1229209940,IDAT);
         method_70(png,1229278788,null);
         return png;
      }
      
      private static function method_70(png:ByteArray, type:uint, data:ByteArray) : void
      {
         var c:uint = 0;
         var n:uint = 0;
         var k:uint = 0;
