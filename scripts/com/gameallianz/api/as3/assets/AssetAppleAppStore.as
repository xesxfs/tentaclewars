package com.gameallianz.api.as3.assets
{
   ...
   public class AssetAppleAppStore extends AssetButton
   {
       
      
      public function AssetAppleAppStore(_container:Sprite = null, _x:Number = 0, _y:Number = 0, _scale:Number = 1)
      {
      ...
      override public function ini() : void
      {
         ...
         var mc_logo:MovieClip = GameAllianzApi.apple_app_store_logo as MovieClip;
         if(mc_logo != null)
         {
            mc_logo_over = GameAllianzApi.apple_app_store_logo as MovieClip;
            §§push(true);
         }
         else
         {
            mc_logo = new AssetAppStoreButtonSkin() as MovieClip;
            mc_logo_over = new AssetAppStoreButtonSkin() as MovieClip;
         }
         mc_logo_over.y = 2;
         ...
         var b_visible:* = GameAllianzApiExtended.action(GameAllianzApiInternalEvent.GET_GAME_INFO,"apple_app_store");
         if(b_visible == null)
         {
            visible = true;
         }
      ...
      {
         validate();
         GameAllianzApi.navigateTo(GameAllianzApiLinks.TO_STORE_GAME_APPLE);
      }
   }
}
