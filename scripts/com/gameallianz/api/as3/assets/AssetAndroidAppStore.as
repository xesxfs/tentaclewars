package com.gameallianz.api.as3.assets
{
   ...
   public class AssetAndroidAppStore extends AssetButton
   {
       
      
      public function AssetAndroidAppStore(_container:Sprite = null, _x:Number = 0, _y:Number = 0, _scale:Number = 1)
      {
      ...
      override public function ini() : void
      {
         ...
         var mc_logo:MovieClip = GameAllianzApi.android_app_store_logo as MovieClip;
         if(mc_logo != null)
         {
            mc_logo_over = GameAllianzApi.android_app_store_logo as MovieClip;
            §§push(true);
         }
         else
         {
            mc_logo = new AssetAndroidButtonSkin() as MovieClip;
            mc_logo_over = new AssetAndroidButtonSkin() as MovieClip;
            mc_logo_over.y = 2;
         ...
         var b_visible:* = GameAllianzApiExtended.action(GameAllianzApiInternalEvent.GET_GAME_INFO,"android_app_store");
         if(b_visible == null)
         {
            visible = true;
         }
      ...
      {
         validate();
         GameAllianzApi.navigateTo(GameAllianzApiLinks.TO_STORE_GAME_ANDROID);
      }
   }
}
