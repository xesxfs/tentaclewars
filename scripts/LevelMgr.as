package
{
   public class LevelMgr
   {
      ...
      private var var_275:Array = null;
      
      private var m_game:Main = null;
      
      private var var_330:Number = 0;
      
      private var var_338:Number = 0;
      
      private var m_currLevel:int = 0;
      
      private var var_392:Number = 0;
      
      private var var_391:Number = 0;
      
      public function LevelMgr(game:Main)
      {
         this.var_338.var_391 = true;
         this.var_275 = new Array(this.method_248,this.method_223,this.method_203,this.method_271,this.method_258,this.method_227,this.method_226,this.method_225,this.method_289,this.method_321,this.method_306,this.method_274,this.method_213,this.method_207,this.method_323,this.method_198,this.method_217,this.method_257,this.method_327,this.method_260);
      }
      
      private function method_306(lvl:Level) : void
      {
      }
      
      private function method_274(lvl:Level) : void
      {
         lvl.initFromCode("6,0,100,0,100,3,10,281,229,3,30,177,318,5,30,414,230,5,30,414,321,5,30,415,134,3,30,178,143,3644");
      }
      
      private function method_213(lvl:Level) : void
      {
      ...
      private function method_289(lvl:Level) : void
      {
      ...
      private function method_323(lvl:Level) : void
      {
      ...
      private function method_198(lvl:Level) : void
      {
      ...
      public function createLevel(id:uint) : Level
      {
      ...
      private function method_257(lvl:Level) : void
      {
      ...
      private function method_321(lvl:Level) : void
      {
      ...
      private function method_226(lvl:Level) : void
      {
      ...
      public function currLevel() : int
      {
         return this.m_currLevel;
      }
      
      private function method_327(lvl:Level) : void
      {
      ...
      private function method_203(lvl:Level) : void
      {
      ...
      private function method_271(lvl:Level) : void
      {
      }
      
      private function method_217(lvl:Level) : void
      {
      ...
      private function method_260(lvl:Level) : void
      {
