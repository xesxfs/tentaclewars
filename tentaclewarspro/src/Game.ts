...
//    import flash.display.egret.Sprite;
...
class Game extends egret.Sprite {
      ...
      private var_106: uint = 0;

      private var_119: Cell = null;

      private const const_16: int = 10;

      private var_185: LevelMgr = null;

      private var_89: Cell = null;

      private var_110: Bitmap = null;

      private var_171: egret.Sprite = null;

      private var_202: int = 3;

      private var_191: uint = 0;

      private var_182: Boolean = false;

      private var_129: String = null;
      ...
      private var_264: uint = 0;

      private var_309: Achievements = null;

      private var_80: int = 0;

      private var_219: egret.Sprite = null;

      private const const_4: uint = 0;

      private var_207: uint = 0;
      ...
      public newAchievement(id: int): void {
            // if(this.var_68) {
            // }
      }
      ...
      private method_140(event: MouseEvent): void {
            var cell: Cell = null;
      ...
      private method_94(lvl: Level): void {
            this.clearLevel();
            this.var_26 = lvl;
      ...
      private method_135(event: MouseEvent): void {
            //             var cell: Cell = null;
            //             §§push(true);
      ...
      private method_276(e: MouseEvent): void {
            var dst: Cell = null;
      ...
      private method_190(id: int): void {
            this.clearTutorial();
            §§push(false);
            §§push(true);
            switch (0) {
